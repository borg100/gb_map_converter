    ...
    class Program
    {
        ...
        public static string HeaderString
        {
            get
            {
                ...
                sb.AppendLine($"{"",4}Generated by gb_map_converter v{v.Major}.{v.Minor}.");
                sb.AppendLine($"{"",4}GitHub: https://github.com/borg100/gb_map_converter");
                return sb.ToString();
            }
        }
        ...
        public class Options
        {
            ...
            [Option('a', "auto-output", Required = false, HelpText = "Output in the same folder as the input image.")]
            public bool AutoOutput { get; set; }
            [Option('o', "output", Required = false, HelpText = "(Overrides auto-output) Output folder to place converted files.")]
        ...
        static void Run(Options options)
        {
            ...
            {
                if (options.AutoOutput)
                {
                    options.OutputFolder = Path.GetDirectoryName(options.InputFile);
                }
                else
                {
